...
@section ('content')
        <h1 id="title">Vista Licencia M</h1>
        <div class="container">
            <div class="centered">
                    ...
                    <div class="row">
                        <div class="card bg-light text-white" style="display: grid; position: relative;
                            ...
                            <div class="card-img-overlay">
                                ...
                                <div style="display: grid; position: absolute; grid-template-columns: 100px 50px; padding: 310px 30px;">
                                    <p class="card-text text-dark font-weight-bold">Nro: {{$licM->id}}</p>
                                </div>
                                <div style="display: grid; position: absolute; grid-template-columns: 100px 50px; padding: 13px 462px;">
                                    <p class="card-text text-dark font-weight-bold">Motocicleta</p>
                                </div>
                                ...
                                <div style="display: grid; position: absolute; grid-template-columns: 100px 50px; padding: 290px 225px;">
                                    <p class="card-text text-dark font-weight-bold">{{$licM->emision}}</p>
                                </div>
                                <div style="display: grid; position: absolute; grid-template-columns: 100px 50px; padding: 290px 350px;">
                                    <p class="card-text text-dark font-weight-bold">{{$licM->vencimiento}}</p>
                                </div>
                                ...
                                <div style="display: grid; position: absolute; grid-template-columns: 100px 50px; padding: 265px 485px;">
                                    <h1 class="card-text text-info font-weight-bold" style="font-size:100px;">M</h1>
                                </div>
                                ...
                                <div style="display: grid; position: relative;
                                    ...
                                    <img style='width:100%; height:68%' class="card-img rounded" src="/storage/app/public/cover_images/{{$licM->cover_image}}" alt="Card image">
                                </div>
                            </div>
                        </div>
                        ...
                        <div id="buttons" class="card" style="width: 18rem;">
                            <div class="card-body">
                                ...
                                <a href="{{route('licenciasM.index')}}" class="btn btn-secondary">Atras</a> 
                            </div>
                        </div>
                    </div>
                </div>
