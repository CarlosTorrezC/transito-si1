                    ...
                    <div class="row justify-content-center">
                        <div class="card border-primary" style="width: 40.0rem;">
                            <div class="card-body">
                                    ...
                                    <h4 class="card-title">Nueva Licencia M</h4>
                                    <hr>
                                    <div class="card-text">
                                        {!! Form::open(['route' => 'licenciasM.store', 'method' => 'POST', 'enctype' => 'multipart/form-data']) !!}
                                        <div class="form-group">
                ...
                {!! Form::open(['route' => 'ciudadano.store', 'method' => 'POST', 'id' => 'modal-details']) !!}
                    ...
                    <div class="form-group">
                        ...
                        {{Form::text('nombres', '', ['class' => 'form-control', 'placeholder' => 'Nombres', 
                                                        'style' => 'text-transform:uppercase', 'autocomplete' => 'off', 'autocomplete' => 'off'])}}
                    </div>
