...
@section ('content')
        <h1 id="title">Vista Licencia A</h1>
        <div class="container">
            <div class="centered">
                        ...
                        <div class="card bg-light text-white" style="display: grid; position: relative;
                            ...
                            <div class="card-img-overlay">
                                ...
                                <div style="display: grid; position: absolute; grid-template-columns: 100px 50px; padding: 310px 30px;">
                                    <p class="card-text text-dark font-weight-bold">Nro: {{$licA->id}}</p>
                                </div>
                                <div style="display: grid; position: absolute; grid-template-columns: 200px 50px; padding: 13px 462px;">
                                    <p class="card-text text-dark font-weight-bold">{{$cat->nombre}}</p>
                                </div>
                                ...
                                <div style="display: grid; position: absolute; grid-template-columns: 100px 50px; padding: 290px 225px;">
                                    <p class="card-text text-dark font-weight-bold">{{$licA->emision}}</p>
                                </div>
                                <div style="display: grid; position: absolute; grid-template-columns: 100px 50px; padding: 290px 350px;">
                                    <p class="card-text text-dark font-weight-bold">{{$licA->vencimiento}}</p>
                                </div>
                                ...
                                <div style="display: grid; position: absolute; grid-template-columns: 100px 50px; padding: 265px 500px;">
                                    <h1 class="card-text text-info font-weight-bold" style="font-size:100px;">{{$licA->categoria_licencia}}</h1>
                                </div>
                                ...
                                <div style="display: grid; position: relative;
                                    ...
                                    <img style='width:100%; height:68%' class="card-img rounded" src="/storage/app/public/cover_images/{{$licA->cover_image}}" alt="Card image">
                                </div>
                            </div>
                        </div>
