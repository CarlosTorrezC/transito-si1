...
@section ('content')
<h1>Crear Nuevo Oficial</h1>
    {!! Form::open(['route' => 'oficial.store', 'method' => 'POST']) !!}
        <div class="container">
            <div class="centered">
                <div class="form-group">  
                    <div class="row justify-content-center">
                        <div class="card border-primary" style="width: 40.0rem;">
                            <div class="card-body">
                                    <h4 class="card-title">Nuevo Oficial</h4>
                                    <div class="card-text">
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            {{Form::number('ci', '', ['class' => 'form-control', 'placeholder' => 'CI Oficial', 'autocomplete' => 'off'])}}
                                        </div>
