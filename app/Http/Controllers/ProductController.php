...
class ProductController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('products.edit', $product->id)->with('success', 'Producto guardado con exito');
    }
    ...
    public function update(Request $request, Product $product)
    {
        ...
        return redirect()->route('products.edit', $product->id)->with('success', 'Producto actualizado con exito');
    }
